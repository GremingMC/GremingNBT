...
public class DoubleTag extends NBTag<Double>
{
    ...
    public DoubleTag() { this(DEFAULT_VALUE); }
    
    
    /**
     * @param value double
     */
    public DoubleTag(double value) { super(TYPE, value); }
    
    
    @Override
    public void encodeBody(ByteBufferWriter writer) { writer.writeFloat64(value); }
    
    
    @Override
    public void decodeBody(ByteBufferReader reader) { value = reader.readFloat64(); }
    
    
    @Override
    public DoubleTag clone() { return new DoubleTag(value); }
