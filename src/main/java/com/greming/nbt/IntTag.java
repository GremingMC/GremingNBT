...
public class IntTag extends NBTag<Integer>
{
    ...
    public IntTag() { this(DEFAULT_VALUE); }
   
    
    /**
     * @param value int 
     */
    public IntTag(int value) { super(TYPE, value); } 

    
    @Override
    public void encodeBody(ByteBufferWriter writer) { writer.writeInt32(value); }
    
    
    @Override
    public void decodeBody(ByteBufferReader reader) { value = reader.readInt32(); }
    
    
    @Override
    public IntTag clone() { return new IntTag(value); }
